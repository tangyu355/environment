...
public interface IProductDao {
	...
	public List<CompanyProduct> findProduct(@Param("groupid") int groupid, @Param("productName") String productName, @Param("tradeid") int tradeid,@Param("year") int year,@Param("districtid") int districtid);

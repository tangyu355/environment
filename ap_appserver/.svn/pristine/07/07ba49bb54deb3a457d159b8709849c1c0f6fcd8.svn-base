...
public class ProductService implements IProductDao {
	...
	public List<CompanyProduct> findProduct(int groupid, String productName,int tradeid,int year,int districtid) {
		return productDao.findProduct(groupid, productName,tradeid,year,districtid);
	}

...
public class Prodres {
	...
	public int getPfillid() {
		return pfillid;
	}
	public void setPfillid(int pfillid) {
		this.pfillid = pfillid;
	}
	...
	public int getConsumeOfYear() {
		return consumeOfYear;
	}
	public void setConsumeOfYear(int consumeOfYear) {

	...
	<div class="mytable">
		<table >
			<thead>
				<tr>
					<th rowspan="2">行业</th>
					<th :colspan="alldata.length" class="text-center">治理设施运行费用（万元）</th>
				</tr>
				<tr>
...
computed: {
	...
	methods: {
      ...
      getall:function(){
					var vm=this;	
					api.analyze.getresult('facilitiesYearCost',vm.yid,vm.industryid,vm.pid).then(function(res){	
						console.log(res)
		...
		getallcity:function(){
					var vm=this;	
					api.analyze.getresult('facilitiesYearCost2',vm.yid,vm.industryid,vm.pid).then(function(res){
						console.log(res)
